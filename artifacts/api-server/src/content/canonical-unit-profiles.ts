...
export function getCanonicalUnitProfile(
  ...
  return [
    ...
    `- Public WIDA framework reference (not official Scaffold guidance): ${CANONICAL_UNIT_PROFILE_SOURCES.widaFramework}`,
    `- Public proficiency reference (not reproduced as official guidance): ${CANONICAL_UNIT_PROFILE_SOURCES.canDo}`,
