...
export const DEMO_LESSON_PLANS: LessonPlan[] = [
  {
    ...
    sourcesUsed: [
      "Scaffold Language Support Level framework",
  ...
  },
  {
    ...
    sourcesUsed: [
      ...
      "Scaffold Language Support Level framework",
      "Scaffold instructional planning rules",
    ],
  },
];
